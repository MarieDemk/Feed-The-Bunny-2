...
var balloon;
var emptyStar, oneStar, twoStars, starScore;
...
function draw() 
{
  ...
  if(collide(fruit,star1,15)==true && star2.visible == true) 
  {
    console.log("!");
    star1.visible = false;
    starScore.changeAnimation('one');
  }
  if(collide(fruit,star2,15)==true && star1.visible == true) 
  {
    star2.visible = false;
    starScore.changeAnimation('one');
  }
  if(collide(fruit,star1,15) == true && star2.visible == false) {
    star1.visible = false;
    starScore.changeAnimation("two");
  }
  if(collide(fruit,star2,15) == true && star1.visible == false) {
    star2.visible = false;
    starScore.changeAnimation("two");
  }
...
function force(){
  Body.applyForce(fruit,{x:0,y:0},{x:0.02,y:-0.02})
}
